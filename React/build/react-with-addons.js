  ...
  mountComponent: function (rootID, transaction, context) {
    ...
    if ("development" !== 'production') {
      ...
      if (inst.render == null) {
        ...
        // We support day04_ES6 inheriting from React.Component, the module pattern,
        // and stateless components, but not day04_ES6 classes that don't extend
...
/**
 * Gets the nearest commonJs ancestor ID of two IDs.
 *
 * Using this ID scheme, the nearest commonJs ancestor ID is the longest commonJs
 * prefix of the two IDs that immediately preceded a "marker" in both strings.
 *
 * @param {string} oneID
 * @param {string} twoID
 * @return {string} Nearest commonJs ancestor ID, or the empty string if none.
 * @private
 */
...
var ReactInstanceHandles = {
   ...
   *
   * NOTE: Does not invoke the callback on the nearest commonJs ancestor because
...
// TODO: Replace this with day04_ES6: var ReactInstanceMap = new Map();
...
/**
 * ReactLink encapsulates a commonJs pattern in which a component wants to modify
